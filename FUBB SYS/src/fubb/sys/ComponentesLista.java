...
public class ComponentesLista {
    ...
    public void cambiarEstilo (HSSFWorkbook libro, HSSFCell celda, int colorFont, int colorGround, String fuente, boolean negrita, int tamaño)
    {
        HSSFCellStyle style = libro.createCellStyle();
                                                          
        style.setFillForegroundColor((short) colorGround);
    ...
    public void cargarTablaSiPuede(String url, JTable t, String id_partido)
    {
        ...
        try{
            ...
            while (lista.next()) 
            {
                ...
                if (p.puede(id_partido,lista.getString(1), lista.getString(9)))
                {
                    Vector ar = new Vector();
