...
public class formulario implements ActionListener
{
    ...
    {
        String url = "SELECT m.id, m.menumadre, m.menuhijo, m.formulario FROM velmaren.menus m, velmaren.permisos p where p.id_usuario = '" + miControlador.miUsuario.id_usuario + "' and p.id_acceso = m.id order by m.menumadre";
        menus = new ArrayList();
